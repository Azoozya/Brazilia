...
*/
struct objet *rechercher_objet(char *nom); //DONE
...
*/
struct objet *creer_objet(char *nom, unsigned short auteur,unsigned int taille, char *data); //DONE
...
*/
int supprimer_objet(char *nom); //DONE
